...
public static partial class MaybeExtensions
{
    extension<T>(Task<Maybe<T>> maybe)
    {
        ...
        /// <param name="onSome">A function to execute if a value is present. Takes the value as an argument and returns a result of type <typeparamref name="TNext"/>.</param>
        /// <param name="onNone">A function to execute if no value is present. Returns a result of type <typeparamref name="TNext"/>.</param>
        /// <returns>
