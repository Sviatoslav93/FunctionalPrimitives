...
public static partial class ResultExtensions
{
    ...
    /// </summary>
    /// <typeparam name="TValue">The type of the value contained in the FunctionalPrimitives when the operation is successful.</typeparam>
    extension<TValue>(Task<Result<TValue>> task)
    {
        /// <summary>
        /// Asynchronously binds the result of a `FunctionalPrimitives{TValue}` to an asynchronous function,
        /// enabling further transformations or operations. If the result represents a failure,
