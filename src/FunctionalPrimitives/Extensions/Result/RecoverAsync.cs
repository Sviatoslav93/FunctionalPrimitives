...
public partial class ResultExtensions
{
    ...
    extension<TValue>(Result<TValue> result)
    {
        ...
        /// </returns>
        public async Task<Result<TValue>> RecoverAsync(Func<IEnumerable<Error>, Task<TValue>> recover)
        {
            if (result.IsSuccess)
                return result;
        ...
        /// </returns>
        public Task<Result<TValue>> RecoverAsync(Func<IEnumerable<Error>, Task<Result<TValue>>> recover)
        {
    ...
    extension<T>(Task<Result<T>> task)
    {
        ...
        /// If the original result is a failure, the result returned by the recovery function is returned.
        /// </returns>
        public Task<Result<T>> RecoverAsync(Func<IEnumerable<Error>, Task<Result<T>>> recover)
        {
