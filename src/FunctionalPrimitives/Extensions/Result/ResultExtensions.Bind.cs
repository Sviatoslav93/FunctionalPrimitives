...
public static partial class ResultExtensions
{
    extension<TValue>(Result<TValue> result)
    {
        ...
        /// </summary>
        /// <typeparam name="TNextValue">The type of the value in the resulting <see cref="FunctionalPrimitives{TNextValue}"/>.</typeparam>
        /// <param name="onSuccess">A function to apply to the value of the successful result.</param>
        /// <returns>
        /// A new <see cref="FunctionalPrimitives{TNextValue}"/> containing the transformed value if the original result was successful,
        ...
        /// <returns>
        /// A new <see cref="FunctionalPrimitives{TNextValue}"/> containing the result produced by the mapping function
