...
public static partial class MaybeExtensions
{
    extension<T>(Maybe<T> maybe)
    {
        ...
        /// </summary>
        /// <typeparam name="TIntermediate">The type of the intermediate value obtained from the binding function.</typeparam>
        /// <typeparam name="TFinal">The type of the final result produced by the selector function.</typeparam>
        ...
        public Maybe<TFinal> SelectMany<TIntermediate, TFinal>(
            ...
            Func<T, TIntermediate, TFinal> projector)
        {
            return maybe.Bind(t =>
