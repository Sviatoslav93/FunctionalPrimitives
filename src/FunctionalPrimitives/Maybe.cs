...
public readonly struct Maybe<T>
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="Maybe{T}"/> representing no value.
    /// </summary>
    public Maybe()
    {
        _value = default!;
    ...
    /// <summary>
    /// Creates a new <see cref="Maybe{TValue}"/> containing the specified non-null value.
    /// </summary>
    /// <typeparam name="TValue">The type of the value.</typeparam>
    /// <param name="value">The value to wrap.</param>
    /// <returns>A <see cref="Maybe{TValue}"/> containing the specified value.</returns>
