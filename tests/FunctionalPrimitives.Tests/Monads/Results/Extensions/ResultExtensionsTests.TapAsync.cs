...
public partial class ResultExtensionsTests
{
    ...
    public async Task TapErrorAsync_ShouldPassCorrectErrors_When_ResultIsFailure()
    {
        ...
        enumerable.ShouldBe(expectedErrors);
    }
    ...
    [Fact]
    public async Task TapErrorAsync_WithAction_ShouldNotExecuteAction_When_ResultIsSuccess()
    {
        // Arrange
        var executed = false;
        var task = Task.FromResult(Success("test"));
        ...
        // Act
        var actualResult = await task.TapErrorAsync(Action);
