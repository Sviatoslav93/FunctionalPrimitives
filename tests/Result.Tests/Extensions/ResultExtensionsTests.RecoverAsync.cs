...
namespace Result.Tests.Extensions
{
    ...
    {
        // RecoverAsync<T>(this Result<T> result, Func<IEnumerable<Error>, Task<T>> recovery)
        [Fact]
        ...
        // RecoverAsync<T>(this Result<T> result, Func<IEnumerable<Error>, Task<Result<T>>> recovery)
        [Fact]
        ...
        // RecoverAsync<T>(this Task<Result<T>> task, Func<IEnumerable<Error>, Task<Result<T>>> recovery)
        [Fact]
        ...
        // RecoverAsync<T>(this Task<Result<T>> task, T fallback)
        [Fact]
